...
class SkeletonLibrary(gui3d.TaskView):
    ...
    def __init__(self, category):
        ...
        import types
        self.human.getSkeleton = types.MethodType(_getSkeleton, self.human.__class__)
        self.human.getVertexWeights = types.MethodType(_getVertexWeights, self.human.__class__)
