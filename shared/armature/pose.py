...
class Pose:
    ...
    def display(self):
        ...
        for bone in list(self.posebones.values()):
            bone.display()
        log.debug(">")
    ...
    def listPose(self):
        for pb in list(self.posebones.values()):
    ...
    def restore(self, shadowBones):
        for pb in list(self.bones.values()):
    ...
    def update(self):
        ...
        for (name,clo) in list(human.clothesObjs.items()):
            if clo:
    ...
    def updateObj(self):
        ...
        print(("UO", list(amt.vertexWeights.keys())))
