...
def test_warp():
    ...
    log.message("difference morph1/morph2 %s", numpy.abs(numpy.array(list(ymorph.values())) - numpy.array(list(ymorph2.values()))).mean() )
    log.message("morph error 1 %s", numpy.abs(numpy.array(list(morph.values())) * (1,3,1) - numpy.array(list(ymorph.values()))).mean() )
    log.message("morph error 2 %s", numpy.abs(numpy.array(list(morph.values())) * (1,3,1) - numpy.array(list(ymorph2.values()))).mean() )
