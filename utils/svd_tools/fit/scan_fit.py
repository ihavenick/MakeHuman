...
class TargetBase(object):
    ...
    def compute_combinaison_safe(self,target,rcond = 0.0,regul = None):
        ...
        if type(target) is str or type(target) is str :
...
if __name__ == '__main__' :
    ...
    if cmd == 'build' :
        ...
        save_target(output,dict(list(zip(base.vert_list,target[base.vert_list]))))
    else :
        print("usage : python scan_fit.py build|project args")
