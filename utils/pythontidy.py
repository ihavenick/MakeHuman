...
MAX_SEPS_FUNC_DEF = 100  # 2007 May 24
MAX_SEPS_FUNC_REF = 100  # 2007 May 24
MAX_SEPS_SERIES = 100  # 2007 May 24
MAX_SEPS_DICT = 100  # 2007 May 24
...
class NodeStr(Node):
    ...
    def put_doc(self, need_blank_line=ZERO):
        doc = self.get_as_str()
        if isinstance(doc, str):  # 2007 May 23
            pass
        else:
            doc = str(doc, INPUT_CODING)
